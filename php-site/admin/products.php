...
<div class="flex min-h-screen bg-gray-100">
  ...
  <aside class="admin-sidebar hidden md:flex flex-col">
    <div class="px-6 py-5 border-b border-white/10">
      <img src="../assets/logo.png" alt="Kesar Kosmetics" class="h-10 object-contain" />
    </div>
    ...
    <tr class="border-b border-[#F0E8DC] hover:bg-[#FAF7F2]">
      <td class="py-3 px-4">
        <div class="flex items-center gap-3">
          <img src="${p.images?.[0]||'../assets/logo.png'}" alt="${p.name}" class="w-10 h-10 object-cover rounded-lg" />
